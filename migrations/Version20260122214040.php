 ...
 */
final class Version20260122214040 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sonata_admin_user DROP username, DROP password, DROP email, DROP roles, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sonata_admin_user ADD username VARCHAR(255) NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, ADD password VARCHAR(255) NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, ADD email VARCHAR(255) NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`, ADD roles JSON NOT NULL, CHANGE id id VARCHAR(255) NOT NULL COLLATE `utf8mb4_uca1400_ai_ci`');
    }
}
